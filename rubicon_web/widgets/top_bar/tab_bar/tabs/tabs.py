...
class Tabs(QTabBar):
    def __init__(self, parent, main_window, *args, **kwargs):
        ...
        if self.main_window.CONFIG["reopen_last_session"] and os.path.exists(self.main_window.configutils.last_session_path):
            with open(self.main_window.configutils.last_session_path, "r") as last_session_file:
