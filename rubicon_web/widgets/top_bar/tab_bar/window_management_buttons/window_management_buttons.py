...
class WindowManagementButtons(QWidget, Ui_window_management_buttons):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.parent().parent().parent().log("WindowManagementButtons are being initialized", "OKAY", "window_management_buttons.py")
        self.setupUi(self)
        self.parent().parent().parent().log("WindowManagementButtons have been initialized", "OKAY", "window_management_buttons.py")